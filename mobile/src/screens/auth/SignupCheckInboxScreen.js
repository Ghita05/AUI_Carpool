...
const styles = StyleSheet.create({
  ...
  headerSubtitle: { fontSize: Typography.md, fontFamily: 'Inter_400Regular', color: 'rgba(255,255,255,0.75)' },
  ...
  heading: { fontSize: Typography['2xl'], fontFamily: 'Inter_700Bold', color: Colors.textPrimary, marginBottom: Spacing.sm, textAlign: 'center' },
  sub: { fontSize: Typography.base, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, textAlign: 'center' },
  emailText: { fontSize: Typography.base, fontFamily: 'Inter_700Bold', color: Colors.textPrimary, textAlign: 'center', marginBottom: Spacing.xs, textDecorationLine: 'underline' },
  instruction: { fontSize: Typography.base, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, textAlign: 'center', marginBottom: Spacing.xl },
  resendRow: { flexDirection: 'row', alignItems: 'center', marginBottom: Spacing.lg },
  resendPrompt: { fontSize: Typography.base, fontFamily: 'Inter_400Regular', color: Colors.textSecondary },
  resendLink: { fontSize: Typography.base, fontFamily: 'Inter_700Bold', color: Colors.primaryLight, textDecorationLine: 'underline' },
  ...
  changePrompt: { fontSize: Typography.base, fontFamily: 'Inter_400Regular', color: Colors.textSecondary },
  changeLink: { fontSize: Typography.base, fontFamily: 'Inter_700Bold', color: Colors.primaryLight, textDecorationLine: 'underline' },
  continueButton: { paddingVertical: Spacing.sm },
  continueText: { fontSize: Typography.md, fontFamily: 'Inter_600SemiBold', color: Colors.textSecondary },
});
