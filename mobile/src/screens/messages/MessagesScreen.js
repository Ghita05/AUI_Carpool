...
const styles = StyleSheet.create({
  ...
  searchInput: { flex: 1, fontSize: Typography.md, fontFamily: 'Inter_400Regular', color: Colors.textPrimary },
  ...
  convAvatarText: { fontSize: Typography.base, fontFamily: 'Inter_700Bold', color: Colors.primary },
  convContent: { flex: 1 },
  convTopRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 2 },
  convName: { fontSize: Typography.md, fontFamily: 'Inter_600SemiBold', color: Colors.textPrimary },
  convTime: { fontSize: Typography.xs, fontFamily: 'Inter_400Regular', color: Colors.textSecondary },
  convBottomRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 3 },
  convPreview: { flex: 1, fontSize: Typography.sm, fontFamily: 'Inter_400Regular', color: Colors.textSecondary },
  unreadBadge: {
    width: 20, height: 20, borderRadius: 10, backgroundColor: Colors.primary,
    alignItems: 'center', justifyContent: 'center', marginLeft: Spacing.sm,
  },
  unreadText: { fontSize: Typography.xs, fontFamily: 'Inter_700Bold', color: Colors.textWhite },
  rideTagRow: { flexDirection: 'row', alignItems: 'center', gap: 3 },
  rideTagText: { fontSize: Typography.xs, fontFamily: 'Inter_400Regular', color: Colors.primary },
  ...
  chatAvatarText: { fontSize: Typography.sm, fontFamily: 'Inter_700Bold', color: Colors.primary },
  chatName: { fontSize: Typography.base, fontFamily: 'Inter_700Bold', color: Colors.textPrimary },
  chatRideTag: { fontSize: Typography.xs, fontFamily: 'Inter_400Regular', color: Colors.primary },
  ...
  bubbleText: { fontSize: Typography.base, fontFamily: 'Inter_400Regular', color: Colors.textPrimary },
  bubbleTextMe: { color: Colors.textWhite },
  bubbleTime: { fontSize: Typography.xs, fontFamily: 'Inter_400Regular', color: Colors.textSecondary, alignSelf: 'flex-end' },
  inputBar: {
  ...
  chatInput: {
    ...
    fontSize: Typography.base, fontFamily: 'Inter_400Regular', color: Colors.textPrimary,
  },
  sendBtn: {
