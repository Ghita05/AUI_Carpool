      ...
      <View style={styles.overlay}>
        <View style={styles.modal}>
          ...
          <View style={styles.detailsBox}>
            ...
            <View style={styles.detailRow}><Ionicons name="calendar-outline" size={16} color={Colors.primary} style={styles.detailIcon} /><Text style={styles.label}>Date:</Text><Text style={styles.value}>{new Date(request.travelDateTime || request.departureDateTime).toLocaleString()}</Text></View>
